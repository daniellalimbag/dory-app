...
class SwimmersActivity : AppCompatActivity() {
    ...
    private fun showEditDialog(swimmer: Swimmer) {
        ...
        val editName = dialogView.findViewById<TextInputEditText>(R.id.editSwimmerName)
        val editPickerMonth = dialogView.findViewById<NumberPicker>(R.id.editPickerMonth)
        val editPickerDay = dialogView.findViewById<NumberPicker>(R.id.editPickerDay)
        val editPickerYear = dialogView.findViewById<NumberPicker>(R.id.editPickerYear)
        val editHeight = dialogView.findViewById<TextInputEditText>(R.id.editSwimmerHeight)
        val editWeight = dialogView.findViewById<TextInputEditText>(R.id.editSwimmerWeight)
        val editRadioGroupSex = dialogView.findViewById<RadioGroup>(R.id.editRadioGroupSex)
        val editRadioMale = dialogView.findViewById<RadioButton>(R.id.editRadioMale)
        val editRadioFemale = dialogView.findViewById<RadioButton>(R.id.editRadioFemale)
        val editWingspan = dialogView.findViewById<TextInputEditText>(R.id.editSwimmerWingspan)
    ...
    private fun updateDayPickerForEdit(pickerDay: NumberPicker, month: Int, year: Int) {
